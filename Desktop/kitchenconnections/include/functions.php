...
class userpdo
{
    ...
    function connectdb()
    {
        ...
        $base = new PDO('mysql:host=localhost;dbname=kitchenconnections', 'root', '');
        return $base;
    }

    public function register($login, $nom, $poste, $pass1, $pass2)
    {
        ...
        else
        {
            if ($etat == 0)
            {
                ...
                $requser = $this->connectdb()->query("INSERT INTO utilisateurs VALUES(NULL, '$login', '$nom', '$poste','$hash')");
    ...
    public function update($login, $nom, $poste, $pass1)
    {
        ...
        $log = $_SESSION['login'];
            ...
            if (strlen($pass1) >= 5)
            {
                ...
                $update = $this->connectdb()->query("UPDATE utilisateurs SET login='$login', nom='$nom', poste='$poste', password='$hash' WHERE login='$log'");
