                    ...
                    <input id="modif" class="btn btn-dark" type="button" value="Modifiez" name="modifier" />
                    </form>
                    ...
                    <input id="effacer" class="btn btn-dark" type="button" value="effacer" name="effacer"></br>
                    </form>